...
public class GestorBBDD {
    ...
    /**
     * Crida la funció SQL per obtenir el record d'un jugador.
     */
    ...
    /**
     * Crida la funció SQL per obtenir la mitja global.
     */
    ...
    /**
     * Crida el procediment SQL per obtenir el ranking de partides jugades.
     * Com que el procediment usa DBMS_OUTPUT, aquí en simulem la lògica o 
     * executem la consulta directament per mostrar-ho al joc de forma bonica.
     */
    ...
    /**
     * Crida el procediment SQL per obtenir el ranking de record personal.
     */
    ...
    /**
     * Obté el percentatge de jugadors amb menys puntuació que la donada.
     */
